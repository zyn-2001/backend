...
public class LocalRestAdminTest {
    ...
    public void itShouldSaveLocalTest() throws Exception {
        ...
        assertEquals(savedDto.getMontantMensuel(), responseBody.getMontantMensuel());
    }
